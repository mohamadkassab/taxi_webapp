...
const Contact = () => {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values, action) => {
      ...
      showAlert("for contacting us", "Thank you");
      ...
      <div className="c3">
          ...
          <div className="c-card">
              <div className="c-left">
                <img className="cimg" src={"./drivers/emailicon.jpg"} alt="" />
              </div>
              <form className="c-right" onSubmit={formik.handleSubmit}>
                ...
                <Box className="cbox2">
                  ...
                  <textarea
                    ...
                    rows="4"
                  ></textarea>
                  <Button className="cbtn" variant="contained" type="submit"  disabled={isSubmitting}>
                    Send Message
                  </Button>
                </Box>
                <Alert alertm={alertm} />
